# Google/Firebase Analytics Plugin (Archived)

**⚠️ This project has been retired and is no longer being maintained. ⚠️**

## Why?

This repository has been archived in favor of [rainlab/googleanalytics-plugin](https://github.com/rainlab/googleanalytics-plugin). The plugin was forked from with the intention of supporting GA4, which at the time it did not support. Now it does so this plugin is redundant and now retired.
